...
import picExp2 from '../../assets/lex4.png';
    ...
    <div className="">
        ...
        >
            <div>
                ...
                <Picture picture={picExp2}  title='Fashion Ecommerce'/>
            </div>
            <div className="grid gap-y-4">
                <TitleLink isHighLight = {isMouseEnter ['ex3']} title='Fashion Ecommerce' link="https://www.google.com/"/>
                ...
                <div >
                    <Tech isHighLight = {isMouseEnter ['ex3']} data={['React', 'Node.js', 'Express']}/>
                </div>
            </div>
        </div>
        
        <div 
            className={`grid grid-cols-[25%_75%] rounded-md px-2 py-6 transition-all ${isMouseEnter ['ex3'] ? "bg-gray-200":""}`}
            onMouseEnter={() => setIsMouseEnter({['ex3']: true})}
            onMouseLeave={() => setIsMouseEnter({['ex3']:false})}
        >
            <div>
                <div>
                    <span className={`text-sm ${isMouseEnter ['ex3'] ?"text-primaryTitle":""}`}>2022-2023</span>
                </div>
                <div>
            ...
            <div className="grid gap-y-4">
                <div className={`text-primaryAccent ${isMouseEnter ['ex3'] ?"text-primaryTitle":""}`}>
                    Fashion Ecommerce
                    <FontAwesomeIcon className={`text-xs -rotate-45 duration-500 ease-out ${isMouseEnter ['ex3'] ? "translate-x-1 -translate-y-1":""}`} icon={faArrowRight}/>
                </div>
                <div className='flex gap-4 text-xl'>
                ...
                <div className="flex gap-4 text-sm">
                    <div className={`bg-pink-200 px-2 py-1 rounded-md ${isMouseEnter ['ex3'] ? "text-primaryTitle" : ""} `}>React</div>
                    <div className={`bg-pink-200 px-2 py-1 rounded-md ${isMouseEnter ['ex3'] ? "text-primaryTitle" : ""} `}>Node.js</div>
                    <div className={`bg-pink-200 px-2 py-1 rounded-md ${isMouseEnter ['ex3'] ? "text-primaryTitle" : ""} `}>Express</div>
                </div>
            </div>
        </div>
    </div>
